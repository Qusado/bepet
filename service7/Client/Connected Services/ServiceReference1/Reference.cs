...
namespace Client.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IService1/SendMess")]
        void SendMess(string msg, int id);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IService1/SendMess")]
        System.Threading.Tasks.Task SendMessAsync(string msg, int id);
    }
    ...
    public partial class Service1Client : System.ServiceModel.DuplexClientBase<Client.ServiceReference1.IService1>, Client.ServiceReference1.IService1 {
        ...
        public void SendMess(string msg, int id) {
            base.Channel.SendMess(msg, id);
        }
        
        public System.Threading.Tasks.Task SendMessAsync(string msg, int id) {
            return base.Channel.SendMessAsync(msg, id);
        }
    }
}
